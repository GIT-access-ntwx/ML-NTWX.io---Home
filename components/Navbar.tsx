...
import { Menu, X, Cpu, LogOut, User as UserIcon } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  const links = [
    ...
    { name: 'See an Example', path: '/#example' },
    { name: 'ROI & Pricing', path: '/pricing' },
  ...
  return (
    <>
      <nav className="fixed w-full z-50 glass-card border-b border-slate-800 bg-opacity-90">
        ...
        {isOpen && (
          <div className="md:hidden glass-card border-t border-slate-800">
