    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-300 text-xs font-bold tracking-widest uppercase mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-20">
            <Link href="/pricing#subscriptions" className="group relative flex items-center p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-purple-500/50 transition-all text-left overflow-hidden">
            ...
            <Link href="/pricing#pay-as-you-go" className="group relative flex items-center p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-cyan-500/50 transition-all text-left overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             ...
             <div className="relative">
                ...
                <div className="relative glass-card rounded-2xl border border-slate-800 overflow-hidden shadow-2xl">
                   ...
                   <div className="p-6 font-mono text-xs md:text-sm leading-6 h-[400px] overflow-y-auto custom-scrollbar text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tools.map((tool, index) => (
            <Link 
              key={index} 
              href={tool.path}
              className={`group relative glass-card p-8 rounded-2xl border ${tool.highlight ? 'border-cyan-500/30' : 'border-slate-800'} hover:border-cyan-500/50 transition-all duration-300 text-left`}
            >
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
           <div className="flex flex-col md:flex-row items-center justify-center gap-12">
              <div className="text-left max-w-md">
                 ...
                 <Link href="/pricing" className="text-cyan-400 font-bold flex items-center group">
...
export default function Home() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-950 flex items-center justify-center text-cyan-400">Loading Agentic Core...</div>}>
      <HomeContent />
    </Suspense>
  );
}